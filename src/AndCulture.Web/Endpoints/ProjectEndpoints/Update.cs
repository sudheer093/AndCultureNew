    ...
    .WithResponse<UpdateProjectResponse>
{
      ...
      CancellationToken cancellationToken)
  {
    ...
    var response = new UpdateProjectResponse(
        ...
        existingProject.BreweryType,
        existingProject.Street,
        existingProject.Address2,
        existingProject.Address3,
        existingProject.City,
        existingProject.State,
        existingProject.CountyProvince,
        existingProject.PostalCode,
        existingProject.Country,
        existingProject.Longitude,
        existingProject.Latitude,
        existingProject.Phone,
